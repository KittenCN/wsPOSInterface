...
namespace PacketWash_ask
{
    public class PacketWash_ask
    {
        public PacketWash_ask()
        { }
        ...
        //冲正/撤销订单号
        private string order_no_washed;
        public string Order_no_washed
        {
            get { return order_no_washed; }
            set { order_no_washed = value; }
        }
        ...
        public void ReadXML(XmlNode xn)
        {
            ...
            Order_no_washed = xn.SelectSingleNode("order_no_washed").InnerText;
