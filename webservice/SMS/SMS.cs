...
namespace SMS
{
    ...
    public class SMS
    {
        ...
        public string send_reg_sms(int intFlag,int int_proindex, string mobile,float floHBB)
        {
            ...
            switch (intFlag)
            {
                case 1:
                    {
                        content = mobile + "用户,您刚刚消费获得:" + floHBB + "个哈宝币.【霓虹儿童广场】";
                        break;
                    }
                case 2:
                    {
                        content = mobile + "用户,您刚刚消费了:" + floHBB + "个哈宝币.【霓虹儿童广场】";
                        break;
                    }
            }            
            string RequestXML = "";
